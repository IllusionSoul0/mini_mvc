...
<div style="max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <form method="POST" action="/produits" style="display: flex; flex-direction: column; gap: 15px;">
        <div>
    ...
    <div style="margin-top: 20px; display: flex; gap: 15px;">
        <a href="/produits" style="color: #007bff; text-decoration: none;">📋 Voir la liste des produits</a>
